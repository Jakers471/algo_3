                    ...
                    @{
                        ...
                        Submenu = @{
                            ...
                            Items = @(
                                ...
                                @{ Label = 'The label, shuffled  (what the tag is; how the histogram builds, panel by panel)'; Run = { python -m scratch.session_research.label_shuffle_explained; Start-Process 'scratch/session_research/label_shuffle_explained.png' } },
                                @{ Label = 'What a REAL edge would look like  (planted weak + strong edges vs the same pile)'; Run = { python -m scratch.session_research.planted_edge; Start-Process 'scratch/session_research/planted_edge.png' } },
                                ...
                                @{ Label = 'Which is real?  (six equity curves: one strategy, five coins. spot it)'; Run = { python -m scratch.session_research.which_is_real; Start-Process 'scratch/session_research/which_is_real.png' } },
                    ...
                    @{
                        ...
                        Submenu = @{
                            ...
                            Items = @(
                                ...
                                @{ Label = 'Four means paper  (each mean dissected step by step - HTML)'; Run = { python -m scratch.algo_metrics.four_means_paper; Start-Process 'scratch/algo_metrics/four_means_paper.html' } }
                            )
                        }
                    },
                    @{
